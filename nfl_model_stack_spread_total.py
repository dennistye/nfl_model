...
#lr_output_df = pd.read_csv("csv_folder/week1_spread_total_predictions_linear_reg.csv")
...
X_spread_stack = np.column_stack((gb_spread_pred, lr_spread_pred))
X_total_stack = np.column_stack((gb_total_pred, lr_total_pred))
...
output_df = pd.DataFrame({
    "Home": gb_output_df["Home"],
    "Visitor": gb_output_df["Visitor"],
